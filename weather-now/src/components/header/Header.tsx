...
const NavDropdown = dynamic(() => import("./NavDropdowns"), { ssr: false });
...
export default function Header() {
    ...
    const textColor = theme === "theme1" ? "#fff" : "#000";

    return (
        <header className="px-[clamp(16px,5vw,40px)] py-[clamp(20px,8vw,44px)]">
            <nav className="flex items-center justify-between">
                {/* Logo */}
                <div className="flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 sm:h-12 lg:h-14" fill="none" viewBox="0 0 197 40">
                        <g clipPath="url(#a)">
                            <path
                                fill="#FF820A"
                ...
                {/* Theme toggle + Units dropdown */}
                <div className="flex items-center justify-between md:gap-4">
                    <button
                        className="cursor-pointer p-2 rounded-lg hover:bg-neutral-300/20 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        onClick={toggleTheme}
                        aria-label="Toggle theme"
                    >
                        {theme === "theme1" ? <LuSun className="size-4 md:size-7 lg:size-8 text-neutral-900" /> : <MdDarkMode className="size-4 md:size-7 lg:size-8 text-neutral-900" />}
                    </button>
                    <NavDropdown />
                </div>
            </nav>
