...
const currentMoviesData = currentAppData.filter(card => card.category === 'Movie'); 

for (let i = 0; i < currentMoviesData.length; i++) {
    const cardData = currentMoviesData[i];
    ...
    cardItem.innerHTML = ` 
        ...
        <div>
            <div class="card-text">
                ...
                <span class="card-category"><img src="./assets/icon-category-movie.svg"> ${cardData.category}</span> • 
...
function updateBackgroundImages() {
    ...
    createdCards.forEach((cardElement, index) => {
        const bgCard = currentMoviesData[index];
